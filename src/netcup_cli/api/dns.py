...
from .client import NetcupAPIClient
...
class DNSManager:
    ...
    def get_records(self, domain: str) -> List[DNSRecord]:
        ...
        if (
            isinstance(response.responsedata, dict)
            and "dnsrecords" in response.responsedata
        ):
    ...
    def update_records(self, domain: str, records: List[DNSRecord]) -> bool:
        ...
        params = {"domainname": domain, "dnsrecordset": {"dnsrecords": records_data}}
